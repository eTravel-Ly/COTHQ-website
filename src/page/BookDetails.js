...
<div className="flex flex-col w-[80%] mt-2 ml-1">
  ...
  <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-reverse md:space-x-4">
        ...
        <div className="md:w-1/4 p-4">
          <img src={ContinueReadingSection1} alt="Book" className="w-60" />
        </div>

        {/* Book Information */}
        <div className="md:w-2/3 p-4">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-2xl font-bold font-tajwal">شرح ثلاثة الأصول</h1>
          </div>
          ...
          <div className="mb-4">
            <div className="flex  text-gray-700">
              ...
              <span className=" flex items-center mr-20 font-bold font-tajwal">الطبعة</span>
            </div>
            <div className="flex  text-gray-700 mt-1">
              <span className="flex items-center ml-52 font-tajwal" >محمد بن صالح العثيمين</span>
              <span className="flex items-center -mr-5 ml-40 font-tajwal" >دار النشر ثريا</span>
              <span className="flex items-center  mr-14  font-tajwal">الطبعة الرابعة 24-1-2024</span>
            </div>
          </div>
          ...
          <table className="w-full text-right">
            <tbody className="space-y-2">
              ...
              <tr className="border-b">
                ...
                <td className="p-4 font-tajwal">1234567890</td>
              </tr>
              <tr className="border-b">
                <td className="p-4 font-tajwal font-bold">الناشر</td>
                <td className="p-4 font-tajwal">دار النشر</td>
              </tr>
              <tr className="border-b">
                <td className="p-4 font-tajwal font-bold">تاريخ النشر</td>
                <td className="p-4 font-tajwal">10 يناير 2004</td>
              </tr>
              <tr className="border-b">
                <td className="p-5 font-tajwal font-bold">عدد الصفحات</td>
        ...
        <div className="md:w-1/3">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center p-2 border">
              <img src={ContinueReadingSection2} alt="Related Book" className="w-16 h-25 ml-10" />
              <div className="ml-4">
            ...
            <div className="flex items-center p-2 border">
              <img src={ContinueReadingSection3} alt="Related Book" className="w-16 h-25 ml-10" />
              <div className="ml-4">
            ...
            <div className="flex items-center p-2 border">
              <img src={ContinueReadingSection1} alt="Related Book" className="w-16 h-25 ml-10" />
              <div className="ml-4">
